%------------------------------------------------------------------------------
% File     : ARI163=1 : TPTP v7.0.0. Released v5.0.0.
% Domain   : Arithmetic
...
% Status   : Theorem
% Rating   : 0.17 v7.0.0, 0.00 v6.3.0, 0.14 v6.2.0, 0.50 v6.1.0, 0.44 v6.0.0, 0.43 v5.5.0, 0.44 v5.4.0, 0.50 v5.3.0, 0.60 v5.2.0, 0.83 v5.1.0, 0.80 v5.0.0
...
%            Arithmetic symbols    :    5 (   1 prd;   1 fun;   2 num;   1 var)
% SPC      : TF0_THM_EQU_ARI
